...
if make_plots
   ...
   rvs_ccf_gauss_binned = RvSpectML.bin_rvs_nightly(rvs_ccf_gauss, nbin)
   rvs_ccf_quad_binned = RvSpectML.bin_rvs_nightly(rvs_ccf_quad, nbin)
   rvs_ccf_cent_binned = RvSpectML.bin_rvs_nightly(rvs_ccf_cent, nbin)
