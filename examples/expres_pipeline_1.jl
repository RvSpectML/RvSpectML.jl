...
if !has_loaded_data
  df_files = make_manifest(target_subdir, EXPRES, max_spectra_to_use = max_spectra_to_use )
...
if !has_computed_ccfs
 ...
 if verbose println("# Reading list list for CCF: ", linelist_for_ccf_filename, ".")  end
