...
min_col_default(inst::EXPRES2D, ord::Integer) = min_col_excalibur(inst, ord)
max_col_default(inst::EXPRES2D, ord::Integer) = max_col_excalibur(inst, ord)
...
default_ccf_v_width(::AnyEXPRES) = 620.953   # TODO: Update value for EXPRES
