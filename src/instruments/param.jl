...
default_calc_chunk_width = ChunkWidthFixedΔlnλ(default_chunk_size_factor*default_line_width_kmps*1000/speed_of_light_mps)  # Used by read_mask_espresso and read_vald
